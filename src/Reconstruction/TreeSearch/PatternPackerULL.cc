...
#define levels 7 //inner and middle.
//#define levels 8 //outer

// this program reads a list of these
typedef  unsigned long long patType; //for inner and middle

//typedef  bitset<69> patType; //for outer
...
map<patType,vector<patType> > tree[levels];// inner and middle
